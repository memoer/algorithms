    ...
    public static void main(String[] args) {
        String[] info = {"java backend junior pizza 150", "python frontend senior chicken 210",
            "python frontend senior " +
                "chicken 150", "cpp backend senior pizza 260", "java backend junior chicken 80",
        ...
        String[] query = {"java and backend and junior and pizza 100", "python and frontend and senior and chicken 200",
            ...
            "100", "- and - and - and - 150"};
        for (int num : new Solution().solution(info, query)) {
